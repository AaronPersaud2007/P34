...
function preload()
{
  ...
  blink = loadAnimation("blink_1.png");
  eat = loadAnimation("eat_0.png", "eat_1.png","eat_2.png");
  sad = loadAnimation("sad_1.png");
...
function setup() 
{
  ...
  bunny = createSprite(200,height-80,900,900);
  bunny.scale = 0.9;
  ...
  star = createSprite(350,50,20,20);
  star.addImage('star',star_img);
  star.scale = 0.02;

  star2 = createSprite(50,370,20,20);
  star2.addImage('star2',star_img);
  star2.scale = 0.02;
